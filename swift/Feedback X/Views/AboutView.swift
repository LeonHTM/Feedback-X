    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 10) {
                ...
                // Tabs for Privacy, Open Source, and Legal
                ZStack {
                    HStack(spacing: 0) {
                        Button(action: {
                    ...
                    if selectedPage == "Open Source" {
                        HStack {
                            VStack(alignment: .leading, spacing: 10) {
                                ...
                                Text("If you encounter an Issue, report it. You can also report a Suggestion for the App. Please check the user guide before submitting an Issue.")
                                    .padding(.top, -5)
                                Button(action: {
                        ...
                        HStack {
                            VStack(alignment: .leading, spacing: 10) {
                                ...
                                Text("Feedback X doesn't collect any data at all.")
                                    .padding(.top, -5)
                                Spacer()
                ...
                // Footer
                HStack(spacing: 7) {
                    Text("This Application was made by LeonHTM")
